...
import { useUser, useBooks, useEntries } from "@/lib/api/hooks";
import { getTextFromContent } from "@/types/journal";
...
export function HomeClient() {
  ...
  const { entries } = useEntries({ limit: 100 });
    ...
    <>
      ...
      >
        <h1 className="text-4xl font-bold mb-3">
          Welcome back{user?.name ? `, ${user.name}` : ""} to{" "}
